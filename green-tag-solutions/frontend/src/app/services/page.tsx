...
const services = [
  { title: "Home Cleaning", desc: "Regular and deep home cleaning with eco-friendly products", price: "₹1,999", icon: HomeIcon, img: "/images/services/service_home_cleaning.jpg", category: "Residential" },
  { title: "Office Cleaning", desc: "Professional office cleaning for corporate spaces", price: "₹2,999", icon: BuildingOffice2Icon, img: "/images/services/service_office_cleaning.jpg", category: "Commercial" },
  { title: "School Cleaning", desc: "Safe and hygienic cleaning for educational institutions", price: "₹3,499", icon: AcademicCapIcon, img: "/images/services/service_school_cleaning.jpg", category: "Institutional" },
  { title: "Hospital Cleaning", desc: "Medical-grade cleaning for healthcare facilities", price: "₹4,999", icon: HeartIcon, img: "/images/services/service_hospital_cleaning.jpg", category: "Healthcare" },
  { title: "Deep Cleaning", desc: "Thorough deep cleaning for neglected spaces", price: "₹3,999", icon: SparklesIcon, img: "/images/services/service_deep_cleaning.jpg", category: "Specialist" },
  { title: "Petrol Pump Cleaning", desc: "Industrial cleaning for fuel stations", price: "₹5,999", icon: CogIcon, img: "/images/services/service_petrol_pump.jpg", category: "Industrial" },
  { title: "Sofa Cleaning", desc: "Professional sofa and upholstery cleaning", price: "₹1,499", icon: SparklesIcon, img: "/images/services/service_sofa_cleaning.jpg", category: "Specialist" },
  { title: "Carpet Cleaning", desc: "Deep carpet and rug cleaning services", price: "₹2,499", icon: ShoppingBagIcon, img: "/images/services/service_carpet_cleaning.jpg", category: "Specialist" },
  { title: "Water Tank Cleaning", desc: "Professional water tank cleaning and disinfection", price: "₹3,299", icon: CogIcon, img: "/images/services/service_water_tank.jpg", category: "Industrial" },
  { title: "Service Station Cleaning", desc: "Automotive service station cleaning", price: "₹4,499", icon: CogIcon, img: "/images/services/service_station_cleaning.jpg", category: "Industrial" },
  { title: "Industrial Cleaning", desc: "Large-scale industrial facility cleaning", price: "Custom", icon: BuildingOffice2Icon, img: "/images/services/service_industrial.jpg", category: "Industrial" },
  { title: "Post Construction Cleaning", desc: "Cleanup after renovation or construction", price: "₹5,999", icon: HomeIcon, img: "/images/services/service_post_construction.jpg", category: "Specialist" },
  { title: "Kitchen Cleaning", desc: "Deep kitchen hood and appliance cleaning", price: "₹2,199", icon: BuildingOffice2Icon, img: "/images/services/service_kitchen_cleaning.jpg", category: "Residential" },
  { title: "Bathroom Sanitization", desc: "Complete bathroom deep cleaning", price: "₹1,799", icon: SparklesIcon, img: "/images/services/service_bathroom_cleaning.jpg", category: "Residential" },
  { title: "Glass Cleaning", desc: "Professional window and glass cleaning", price: "₹999", icon: BuildingOffice2Icon, img: "/images/services/service_glass_cleaning.jpg", category: "Commercial" },
  { title: "Pest Control Services", desc: "Complete pest control and elimination", price: "₹1,499", icon: BugAntIcon, img: "/images/services/service_pest_control.jpg", category: "Specialist" },
  { title: "Floor Polishing", desc: "Marble and tile floor polishing", price: "₹2,799", icon: SparklesIcon, img: "/images/services/service_floor_polishing.jpg", category: "Specialist" },
  { title: "Marble Polishing", desc: "Professional marble restoration", price: "₹3,499", icon: SparklesIcon, img: "/images/services/service_marble_polishing.jpg", category: "Specialist" },
  { title: "Apartment Cleaning", desc: "Complete apartment deep cleaning", price: "₹2,499", icon: HomeIcon, img: "/images/services/service_apartment_cleaning.jpg", category: "Residential" },
];
